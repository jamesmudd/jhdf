...
The intention is to make a clean Java API to access HDF5 data. Currently, reading is very well-supported and writing supports limited use cases. For progress see the [change log](CHANGES.md). Java 17, 21 and 25 are officially supported.
...
- Easy integration with JVM based projects. The library is available on [Maven Central](https://central.sonatype.com/artifact/io.jhdf/jhdf), [GitHub Packages](https://github.com/jamesmudd/jhdf/packages/), and [JitPack.io](https://jitpack.io/#io.jhdf/jhdf) so using it should be as easy as adding any other dependency. To use the libraries supplied by the HDF Group you need to load native code, which means you need to handle this in your build, and it complicates distribution of your software on multiple platforms.
