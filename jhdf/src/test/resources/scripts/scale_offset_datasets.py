...
def write_chunked_datasets(f):
    ...
    int_group = f.create_group('int_simple')
    int_group.create_dataset('int8', data=data, dtype='i1', chunks=(4), scaleoffset=0)
    int_group.create_dataset('int8_3', data=data, dtype='i1', chunks=(4), scaleoffset=1)
    int_group.create_dataset('int16', data=data, dtype='i2', chunks=(4), scaleoffset=0)
    int_group.create_dataset('int16_3', data=data, dtype='i2', chunks=(3), scaleoffset=0)
    int_group.create_dataset('int32', data=data, dtype='i4', chunks=(4), scaleoffset=0)
    int_group.create_dataset('int32_3', data=data, dtype='i4', chunks=(5), scaleoffset=0)
