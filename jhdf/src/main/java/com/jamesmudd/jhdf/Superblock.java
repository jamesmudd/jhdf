...
public class Superblock {
  ...
  public Superblock(RandomAccessFile file, long offset) {
    try {
      ...
      logger.trace("Version # of Root Group Symbol Table Entry: {}",
      ...
      logger.trace("Version # of Shared Header Message Format: {}",
  ...
  /**
   * Checks if the file provided contains the HDF5 file signature at the given offset.
   * 
   * @param file The file to test
   * @param offset The offset into the file where the superblock starts
   * @return <code>true</code> if signature is matched <code>false</code> otherwise
   */
