...
public class SymbolTableEntry {
  ...
  public SymbolTableEntry(RandomAccessFile file, long address, int sizeOfOffsets)
      throws IOException {
  ...
  public String toString() {
    return "SymbolTableEntry [address=" + toHex(address) + ", linkNameOffset=" + linkNameOffset
        + ", objectHeaderAddress=" + toHex(objectHeaderAddress) + ", cacheType=" + cacheType
        + ", bTreeAddress=" + toHex(bTreeAddress) + ", nameHeapAddress=" + toHex(nameHeapAddress)
