...
public class BTreeNode {
  ...
  public BTreeNode(RandomAccessFile file, long address, int sizeOfOffsets, int sizeOfLengths,
      int leafK, int internalK) {
  ...
  public String toString() {
    return "BTreeNode [address=" + toHex(address) + ", nodeType=" + nodeTypeAsString(nodeType)
        + ", nodeLevel=" + nodeLevel + ", entriesUsed=" + entriesUsed + ", leftSiblingAddress="
        + toHex(leftSiblingAddress) + ", rightSiblingAddress=" + toHex(rightSiblingAddress) + "]";
  }
